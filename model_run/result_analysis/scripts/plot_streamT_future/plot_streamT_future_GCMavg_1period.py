...
# This script plots control and future stream temperatures for one future period, and with RCP4.5 and RCP8.5 on the same plot
...
ax = plt.subplot()
fig, ax = my_functions.plot_time_series(fig, ax, plot_date=False, df_data=df_season_to_plot, \
        ...
        fontsize=24, legend_loc='upper left', \
...
fig = plt.savefig('{}.{}.Tstream.seas.png'\
...
fig = plt.savefig('{}.future.Tstream_duration.png'\
                        .format(cfg['OUTPUT']['output_plot_basepath']), \
                  format='png', dpi=dpi)

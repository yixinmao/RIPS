...
route_station_file = '/raid2/ymao/VIC_RBM_east/VIC_RBM/model_run/param/Lohmann_route/Wu_8th/Tennessee/Tennessee.Rout.Cells'  # Lohmann routing station file (this is for determining station name of a grid cell)
route_hist_output_dir = '/raid2/ymao/VIC_RBM_east/VIC_RBM/model_run/output/Lohmann_route/reclamation_CMIP5/Tennessee_1949_2010_historical_for_comparison'  # directory of Lohmann route output - historical run
GCM_list = '/raid2/ymao/VIC_RBM_east/VIC_RBM/model_run/result_analysis/data/scenario_list_temp'  # list of future GCMs to be plotted; e.g.: ccsm4. For each GCM, there are rcp45 and rcp85 runs; the final name of scenario files are like: 'ccsm4_rcp85_r1i1p1'
